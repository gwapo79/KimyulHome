    ...
    return (
        <main className="bg-white min-h-screen">
            ...
            <section id="article-body" className="py-16 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    {/* Using dangerouslySetInnerHTML because our seed data contains HTML structure */}
                    {/* The content is trusted since it comes from our seed script. */}
                    <div
                        className="prose max-w-none text-[#535861]"
